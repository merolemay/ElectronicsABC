...
public class CustomerOrderController {
    ...
    @GetMapping("/show")
    public String show(){return "Order/orders";}

    @GetMapping("/index")
    public String showIndex(){return "index";}

    @GetMapping("/edit")
    public String showEdit(){return "Order/editOrder";}

    @GetMapping("/delete")
    public String showDelete(){return "Order/deleteOrder";}

    @GetMapping("/view")
    public String showTable(){return "Order/viewTable";}
